...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('OMG Alpha', 350, 1200, -3, '', 'weapon', 'gun', '', 1000, 'var.Kaliber:leicht,mittel|dist:15.50|dmg:2/0|chambers:1'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon', 'gun', '', 1000, 'dist:10.40|dmg:2/0|chambers:1'),
            ('ParaTec Vulpus .38', 300, 1250, -3, '', 'weapon', 'gun.revolver', '', 1000, 'dist:20.60|dmg:2/0|chambers:6'),
            ('ParaTec Ursus .357', 500, 1250, -3, '', 'weapon', 'gun', '', 1000, 'dist:10.50|dmg:2/-1|chambers:1'),
            ('ParaTec Ursus .500', 800, 1750, -1, '', 'weapon', 'gun', '', 1000, 'dist:15.75|dmg:3/0|chambers:1'),
            ('ParaTec Ursus 12/76', 1200, 2050, 1, '', 'weapon', 'gun', '', 1000, 'dist:15.75|dmg:3/-1|chambers:1'),
            ('II .357 Marshal Art', 750, 1250, -3, '', 'weapon', 'gun.revolver', '', 1000, 'dist:10.50|dmg:2/-1|chambers:6'),
            ('OMG Gamma 7.62', 1050, 3500, -1, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|dmg:3/-2|chambers:1'),
            ('Paratec Lupus', 950, 3500, 0, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|dmg:2/-2|chambers:1'),
            ('Insight Industries Ambassador .223', 1850, 3400, 2, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|dmg:2/-2|chambers:1'),
            ('Furthmayr & DeWal Musketier .308', 2150, 3800, 1, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|dmg:3/-2|chambers:1'),
            ('Paratec Gulo', 800, 4000, -2, '', 'weapon', 'shotgun', '', 1000, 'dist:20.50|dmg:3/1|chambers:1'),
            ('Furthmayr & DeWal Wildschütz', 900, 4800, -2, '', 'weapon', 'shotgun', '', 1000, 'dist:20.50|dmg:3/1|chambers:1'),
            ('OMG Beta 9mm', 750, 2800, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|dmg:2/0|chambers:1'),
            ('SMI Cadenca 9mm', 650, 2400, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|dmg:2/0|chambers:1'),
            ('Paratec Canis 9mm', 500, 2400, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|dmg:2/0|chambers:1'),
            ('OMG Delta 7.62', 1500, 4500, 0, '', 'weapon', 'rifle.automatic', '', 1000, 'dist:50.250|dmg:3/-2|chambers:1'),
            ('AK 47', 1050, 3500, 0, '', 'weapon', 'rifle.automatic', '', 1000, 'dist:50.250|dmg:3/-2|chambers:1'),
            ...
            ('Magazin', 20, 50, -4, '', 'clipsnmore', 'clips', '', 500, 'var.Kaliber:leicht,mittel,schwer|capacity:6'),
