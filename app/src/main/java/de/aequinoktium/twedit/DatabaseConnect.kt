...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('OMG Alpha 9mm', 350, 1200, -3, '', 'weapon', 'gun', '', 1000, 'caliber:pistol.medium|dist:15.50|chambers:1|clip:0'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon', 'gun', '', 1000, 'caliber:pistol.medium|dist:10.40|chambers:1|clip:0'),
            ('ParaTec Vulpus .38', 300, 1250, -3, '', 'weapon', 'gun.revolver', '', 1000, 'dist:20.60|chambers:6'),
            ('ParaTec Ursus .357', 500, 1250, -3, '', 'weapon', 'gun', '', 1000, 'dist:10.50|chambers:1|clip:0'),
            ('ParaTec Ursus .500', 800, 1750, -1, '', 'weapon', 'gun', '', 1000, 'dist:15.75|chambers:1|clip:0'),
            ('ParaTec Ursus 12/76', 1200, 2050, 1, '', 'weapon', 'gun', '', 1000, 'dist:15.75|chambers:1|clip:0'),
            ('II .357 Marshal Art', 750, 1250, -3, '', 'weapon', 'gun.revolver', '', 1000, 'dist:10.50|chambers:6'),
            ('OMG Gamma 7.62', 1050, 3500, -1, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Paratec Lupus', 950, 3500, 0, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Insight Industries Ambassador .223', 1850, 3400, 2, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Furthmayr & DeWal Musketier .308', 2150, 3800, 1, '', 'weapon', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Paratec Gulo', 800, 4000, -2, '', 'weapon', 'shotgun', '', 1000, 'dist:20.50|chambers:1|clip:0'),
            ('Furthmayr & DeWal Wildschütz', 900, 4800, -2, '', 'weapon', 'shotgun', '', 1000, 'dist:20.50|chambers:1|clip:0'),
            ('OMG Beta 9mm', 750, 2800, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('SMI Cadenca 9mm', 650, 2400, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('Paratec Canis 9mm', 500, 2400, -2, '', 'weapon', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('OMG Delta 7.62', 1500, 4500, 0, '', 'weapon', 'rifle.automatic', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('AK 47', 1050, 3500, 0, '', 'weapon', 'rifle.automatic', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Pulspistole SMI RC 1', 500, 1500, -1, '', 'weapon', 'gun.blaster', '', 1000, 'dist:25.150|chambers:1'),
            ('Pulsgewehr SMI RC 2', 1200, 2800, -1, '', 'weapon', 'rifle.blaster', '', 1000, 'dist:50.500|chambers:1'),
            ('Laserpistole SMI Prism', 650, 1400, -1, '', 'weapon', 'gun.blaster', '', 1000, 'dist:25.150|chambers:1'),
            ('Lasergewehr ParaTec Lynx', 1300, 3500, 1, '', 'weapon', 'rifle.blaster', '', 1000, 'dist:800|chambers:1'),
