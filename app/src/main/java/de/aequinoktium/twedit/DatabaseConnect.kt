...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('Unterhose', 10, 100, -5, '', 'clothing', 'casual', 'hips', 0, 'var.Ausführung: ,Einweg#|var.Design: ,Spitzen#.p200|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75|col:*'),
            ('Boxershorts', 10, 100, -5, '', 'clothing', 'casual', 'hips', 0, 'var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75|col:*'),
            ('Unterhemd', 10, 100, -5, '', 'clothing', 'casual', 'torso', 0, 'var.Design: ,Spitzen#.p200|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75|col:*'),
            ('Hose', 40, 400, -5, '', 'clothing', 'casual.formal.work.sports', 'hips.legs', 200, 'var.Variante: ,Cargo#.p150.wl500,Anzug#.p200,Sport#|var.Länge: ,Kurze# |var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*|cnt:Hosentaschen'),
            ('Leggins', 20, 200, -5, '', 'clothing', 'casual.sports', 'hips.legs', 0, 'var.Material:Kunstfaser|col:*'),
            ('Rock', 30, 300, -5, '', 'clothing', 'casual.formal', 'hips.legs', 0, 'var.Schnitt: ,Falten#,Bleistift#,Wickel#,Ballon#|var.Länge: ,Mini#,Kurzer #,Midi#,Maxi#,Langer #|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*'),
            ('T-Shirt', 15, 300, -5, '', 'clothing', 'casual.sports', 'torso', 0, 'var.Material:Kunstfaser,Baumwolle.p120|col:*'),
            ('Hemd', 40, 300, -5, '', 'clothing', 'casual.work.formal', 'torso.arms', 100, 'var.Ärmel: ,Kurzärmliges #|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75|col:*|cnt:Hemdtasche'),
            ...
            ('Pullover', 50, 500, -5, '', 'clothing', 'casual.work', 'torso.arms', 0, 'var.Variante: ,Rollkragen#,Kaputzen#|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75|col:*'),
            ('Overall', 75, 1000, -5, '', 'clothing', 'casual.work', 'torso.arms.legs', 750, 'var.Ärmel: ,Kurzärmliger #,Ärmelloser #|var.Material:Kunstfaser,Baumwolle.p120|col:*|cnt:Overalltaschen'),
            ('Kittel', 50, 1000,0, '', 'clothing', 'work', 'torso.arms', 250, 'var.Ausführung: ,Labor#,Arbeits#|var.Material:Kunstfaser,Baumwolle.p120|col:*|cnt:Kitteltaschen'),
            ('Kleid', 50, 500, -5, '', 'clothing', 'casual.work.formal', 'torso.legs', 0, 'var.Variante: ,Abend#.p500,Gala#.p1000|var.Länge: ,Kurzes #,Langes #.p150.w150|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*'),
            ('Weste', 50, 500, -5, '', 'clothing', 'casual.work.sports', 'torso', 500, 'var.Variante: ,Sport#,Outdoor.p200.w200#,Thermo#.p300.w300,Anzug#.p200,Taktische #.w200.p200.d±0/+1,Kugelsichere #.w500.p1000.d±0/+2,Panzer#.w1000.p5000.d-1/+2|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*|cnt:Jackentaschen'),
            ('Jacke', 50, 500, -5, '', 'clothing', 'casual.work.sports', 'torso.arms', 500, 'var.Variante: ,Sport#,Outdoor.p200.w200#,Thermo#.p300.w300,Anzug#.p200,##Jackett.p200,##Sakko.p200,##Frack.p200|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*|cnt:Jackentaschen'),
            ('Mantel', 50, 750, -5, '', 'clothing', 'casual.work.sports', 'torso.arms', 500, 'var.Länge: ,Kurzer #,Langer #.p150.w150|var.Material:Kunstfaser,Baumwolle.p120,Wolle.p200.w150,Seide.p250.w75,Jeans,Leder.p500.w250|col:*|cnt:Manteltaschen'),
            ...
            ('Schuhe', 50, 500, -5, '', 'clothing', 'casual.formal.work.sports', 'feet', 0, 'var.Variante: ,Arbeits#.p200.w150,Sicherheits#.p200.w200,Sport#,Lauf#.w75,|col:*'),
            ('High-Heels', 50, 400, 0, '', 'clothing', 'casual.formal.work.sports', '', 0, 'col:*'),
            ('Stiefel', 100, 1000, 0, '', 'clothing', 'casual.work.sports', 'feet', 0, 'var.Variante: ,Arbeits#.w120,Outdoor#.p150.w120,Gummi#.p50.w150,Kampf#.p200.w150,Bord#.p250.w150,High-Heel-#|var.Höhe: ,Niedrige #,Hohe #|var.Material:Kunstfaser,Leder.p150,Gummi|col:*'),
            ...
            ('Rucksack', 50, 500, 0, 'Praktisches Transportbehältnis, das am Rücken getragen werden kann. ', 'container', '', 'back', 10000, 'var.Ausführung: ,Wander#,Reise#,Outdoor#|var.Größe: ,Kleiner #.p50.w50.wl-5000,Großer #.p150.w200.wl10000|var.Verschluss:Schnallen,Reißverschluss,Knöpfe,Schnürung|var.Material:Kunstfaser,Leder.p250.w200|col:*'),
            ('Tasche', 20, 250, 0, 'Ein üblicherweise weichwandiges Transportbehältnis, das oft einen Verschluss besitzt und meist Trageschlaufen zum Transport besitzt. ', 'container', '', 'hands1', 10000, 'var.Ausführung: ,Reise#,Sport#,Einkaufs#.p10|var.Größe: ,Kleine #.p50.w50.wl-5000,Große #.p150.w200.wl10000|var.Verschluss:Keiner,Schnürung,Reißverschluss,Klettverschluss|var.Material:Plastik,Kunstfaser,Leder.p250.w200|col:*'),
            ('Holster', 20, 100, 0, 'Ein Behälter für Waffen oder Ausrüstungsgegenständen. ', 'container', '', 'belt', 1000, 'var.Ausführung: ,Werkzeug#,Waffen#,##Messerscheide,##Schwertscheide|var.Material:Kunstfaser,Leder.p250.w200|col:*'),
            ('Gürteltasche', 10, 100, 0, 'Eine Tasche, die üblicherweise am Gürtel befestigt wird. ', 'container', '', 'belt', 1000, 'var.Größe: ,Kleine #.wl-500,Große #.wl1000|var.Material:Kunstfaser,Leder.p250.w200|col:*'),
            ...
            ('Seesack', 20, 250, 0, 'Eine üblicherweise zylindrisch geschnittene Tasche, die auf einer der kurzen Seiten über eine verschließbare Öffnung verfügt. Es gibt oft Trageriemen, an welchem der Sack über die Schulter gehängt werden kann. ', 'container', '', 'hands1', 10000, 'var.Größe: ,Kleiner #.p50.w50.wl-5000,Großer #.p150.w200.wl10000|var.Verschluss:Schnürung,Reißverschluss,Klettverschluss|var.Material:Kunstfaser,Baumwolle|col:*'),
