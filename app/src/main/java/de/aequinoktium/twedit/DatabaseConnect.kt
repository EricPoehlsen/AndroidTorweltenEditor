...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('OMG Alpha 9mm', 350, 1200, -3, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.medium|dist:15.50|chambers:1|clip:0'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.medium|dist:10.40|chambers:1|clip:0'),
            ('ParaTec Vulpus .38', 300, 1250, -3, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'dist:20.60|chambers:6'),
            ('ParaTec Ursus .357', 500, 1250, -3, '', 'weapon_ranged', 'gun', '', 1000, 'dist:10.50|chambers:1|clip:0'),
            ('ParaTec Ursus .500', 800, 1750, -1, '', 'weapon_ranged', 'gun', '', 1000, 'dist:15.75|chambers:1|clip:0'),
            ('ParaTec Ursus 12/76', 1200, 2050, 1, '', 'weapon_ranged', 'gun', '', 1000, 'dist:15.75|chambers:1|clip:0'),
            ('II .357 Marshal Art', 750, 1250, -3, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'dist:10.50|chambers:6'),
            ('OMG Gamma 7.62', 1050, 3500, -1, '', 'weapon_ranged', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Paratec Lupus', 950, 3500, 0, '', 'weapon_ranged', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Insight Industries Ambassador .223', 1850, 3400, 2, '', 'weapon_ranged', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Furthmayr & DeWal Musketier .308', 2150, 3800, 1, '', 'weapon_ranged', 'rifle', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Paratec Gulo', 800, 4000, -2, '', 'weapon_ranged', 'shotgun', '', 1000, 'dist:20.50|chambers:1|clip:0'),
            ('Furthmayr & DeWal Wildschütz', 900, 4800, -2, '', 'weapon_ranged', 'shotgun', '', 1000, 'dist:20.50|chambers:1|clip:0'),
            ('OMG Beta 9mm', 750, 2800, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('SMI Cadenca 9mm', 650, 2400, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('Paratec Canis 9mm', 500, 2400, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'dist:25.75|chambers:1|clip:0'),
            ('OMG Delta 7.62', 1500, 4500, 0, '', 'weapon_ranged', 'rifle.automatic', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('AK 47', 1050, 3500, 0, '', 'weapon_ranged', 'rifle.automatic', '', 1000, 'dist:50.250|chambers:1|clip:0'),
            ('Pulspistole SMI RC 1', 500, 1500, -1, '', 'weapon_ranged', 'gun.blaster', '', 1000, 'dist:25.150|chambers:1'),
            ('Pulsgewehr SMI RC 2', 1200, 2800, -1, '', 'weapon_ranged', 'rifle.blaster', '', 1000, 'dist:50.500|chambers:1'),
            ('Laserpistole SMI Prism', 650, 1400, -1, '', 'weapon_ranged', 'gun.blaster', '', 1000, 'dist:25.150|chambers:1'),
            ('Lasergewehr ParaTec Lynx', 1300, 3500, 1, '', 'weapon_ranged', 'rifle.blaster', '', 1000, 'dist:800|chambers:1'),
            ('Ko Punt Gun', 10000, 50000, -3, '', 'weapon_ranged', '', '', 1000, 'dist:100.5000|dmg:5/-6|chambers:1'),
            ...
            ('Leuchtspurgeschoss', 3, 15, -1, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/0'),
            ('Signalpatrone', 5, 20, -3, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/+1'),
            ...
            ('Salzpatrone', 0.5, 50, -2, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/+2')
        """.trimIndent()
        db.execSQL(sql)
