...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('OMG Alpha 9mm', 350, 1200, -3, '', 'weapon', 'gun', '', 1000, 'caliber:pistol.medium|dist:15.50|dmg:2/0|chambers:1'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon', 'gun', '', 1000, 'caliber:pistol.medium|dist:10.40|dmg:2/0|chambers:1'),
