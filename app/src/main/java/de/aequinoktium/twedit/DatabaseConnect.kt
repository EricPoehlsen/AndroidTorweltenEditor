...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('Sandalen', 20, 200, -5, '', 'clothing', 'casual.work.formal', '', 0, 'col:*'),
            ...
            ('Werkzeug', 50,500,-4, 'Werkzeug in einem passenden Behältnis', 'tool', '', '', 100, 'var.Variante:##Werkzeugmappe,##Werkzeugkasten.p1000.w500.wl400,##Werkzeugkoffer.p5000.w1900.wl2400|var.Ausführung:universell,Elektriker#,Umwelttechnik#,Computer#,Spezial#'),
            ('Hammer', 10,250,-5, '', 'tool', 'mechanic', 'hands1', 0, 'var.Form:egal,Schlosser#,Tischler#,Zimmermanns#,Ingenieurs#,Gummi#.d+0/+1,Holz.d+0/+1#Maurer#|var.Gewicht:,leichter #.w50.p150.d-1/+0,schwerer #.w1000,überschwerer #.w2000.p200.d+1/+0|dmg:1/0'),
            ('Schraubendreher', 10,75,-5, '', 'tool', 'mechanic', 'hands1', 0, 'var.Form:egal,Schlitz#,Kreuzschlitz#,Torx#,Inbus#|var.Größe:egal,kleiner #.w66,großer #.w200|dmg:1/0'),
            ('Schraubenschlüssel', 10,50,-5, '', 'tool', 'mechanic', 'hands1', 0, 'var.Form:egal,##Maulschlüssel,##Ringschlüssel,##Varioschlüssel.p200|var.Größe:egal,kleiner #,mittlerer #.w500,großer #w2500.p200.d1/0,sehr großer #.w5000.p500.d2/0'),
            ('Zange', 10,100,-5, '', 'tool', 'mechanic', 'hands1', 0, 'var.Form:egal,##Flachzange,##Kombizange,##Rundzange,##Wasserpumpenzange,##Rohrzange,##Drahtzange,##Beißzange|var.Größe:egal,kleine #.w50,mittlere #,große #.w500.p250.d1/0,sehr große #.w2500.d2/0.p500'),
            ('Säge', 10,100,-5, '', 'tool', 'mechanic', 'hands1', 0, ''),
            ...
            ('Streitaxt', 250, 2000, -2, 'Eine schwarfe Hiebwaffe die wirklich unschöne Verletzungen verursacht. Gegenüber einer Werkzeugaxt, ist die Waffe deutlich weniger kopflastig, sie lässt sich schneller schwingen.', 'weapon_melee', 'blunt', '', 0, 'dmg:2/-1'),
            ('Kriegshammer', 250, 2000, -2, 'Im Gegensatz zur Streitaxt, endet diese Waffe mit einem relativ stumpfen Ende. Trotzdem möchte man nicht auf der falschen Seite dieser Waffe stehen.', 'weapon_melee', 'blunt', '', 0, 'dmg:2/0'),
            ('Streitkolben', 250, 2000, -2, 'Das hier ist die professionelle Variante des Knüppels. Metallbeschläge und scharfe Kanten machen aus einem ohnehin schon gefährlichen Gegenstand eine tödliche Waffe.', 'weapon_melee', 'blunt', '', 0, 'dmg:2/0'),
            ('Morgenstern', 250, 2000, -2, 'In seiner Grundform handelt es sich bei dieser Waffe um einen stachelbewehrten Streitkolben, in einer abgewandelten Variante, befinden sich eine oder mehrere stachelbewehrte Kugeln, mit Ketten befestigt, frei schwingend am Ende des Stabes', 'weapon_melee', 'blunt', '', 0, 'dmg:2/0'),
            ('Knüppel', 50, 1000, -5, 'Eine stumpfe Hiebwaffe', 'weapon_melee', 'blunt', '', 0, 'dmg:2/1'),
            ('Vorschlaghammer', 50, 5000, -2, '', 'weapon_melee', 'blunt', '', 0, 'dmg:3/0'),
            ('Betäubungsstab', 100, 1000, -2, '', 'weapon_melee', 'blunt', '', 0, 'dmg:3/-1/E'),
            ('Taktisches Messer', 50, 150, -3, '', 'weapon_melee', 'knife', '', 0, 'dmg:1/-1'),
            ('Vibromesser', 250, 250, 0, '', 'weapon_melee', 'knife', '', 0, 'dmg:2/-1'),
            ('Kurzdolch', 50, 250, -3, '', 'weapon_melee', 'knife', '', 0, 'dmg:1/-1'),
            ('Stilett', 100, 400, 0, '', 'weapon_melee', 'knife', '', 0, 'dmg:1/-2'),
            ('Katar', 150, 250, 2, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Szizsan', 350, 600, -1, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Schattenklinge', 4500, 800, 3, '', 'weapon_melee', 'blade', '', 0, 'dmg:4/-1'),
            ('Breitschwert', 500, 1400, -2, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Jian', 500, 1200, 1, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Entermesser', 200, 800, -2, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Infanteriesäbel', 400, 1200, -1, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Katana', 500, 1500, 0, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Szimitar', 500, 1500, 1, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('Laserschwert', 2000, 1000, 3, '', 'weapon_melee', 'blade', '', 0, 'dmg:3/-2'),
            ('Schlagring', 25, 200, -3, '', 'weapon_melee', 'blunt', '', 0, 'dmg:1/0'),
            ('Schockhandschuh', 150, 250, -2, '', 'weapon_melee', 'stun', '', 0, 'dmg:3/-2/E'),
            ('Krallenhandschuhe', 150, 250, 0, '', 'weapon_melee', 'blade', '', 0, 'dmg:2/0'),
            ('OMG Alpha 9mm', 350, 1200, -3, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('ParaTec Vulpus .22', 300, 750, -3, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.light|chambers:1|clip:0'),
            ('ParaTec Vulpus .38', 300, 1250, -3, '', 'weapon_ranged', 'gun', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('ParaTec Ursus .357', 500, 1250, -3, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'caliber:pistol.medium|chambers:6'),
            ('ParaTec Ursus .500', 800, 1750, -1, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'caliber:pistol.heavy|chambers:6'),
            ('ParaTec Ursus 12/76', 1200, 2050, 1, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'caliber:shotgun.heavy|chambers:5'),
            ('II .357 Marshal Art', 750, 1250, -3, '', 'weapon_ranged', 'gun.revolver', '', 1000, 'caliber:pistol.medium|chambers:6'),
            ('OMG Gamma 7.62', 1050, 3500, -1, '', 'weapon_ranged', 'rifle', '', 1000, 'caliber:rifle.medium|chambers:1|clip:0'),
            ('Paratec Lupus', 950, 3500, 0, '', 'weapon_ranged', 'rifle', '', 1000, 'caliber:rifle.medium|chambers:1|clip:0'),
            ('Insight Industries Ambassador .223', 1850, 3400, 2, '', 'weapon_ranged', 'rifle', '', 1000, 'caliber:rifle.light|chambers:1|clip:0'),
            ('Furthmayr & DeWal Musketier .308', 2150, 3800, 1, '', 'weapon_ranged', 'rifle', '', 1000, 'caliber:rifle.heavy|chambers:1|clip:0'),
            ('Paratec Gulo', 800, 4000, -2, '', 'weapon_ranged', 'shotgun', '', 1000, 'caliber:shotgun.heavy|chambers:1|clip:0'),
            ('Furthmayr & DeWal Wildschütz', 900, 4800, -2, '', 'weapon_ranged', 'shotgun', '', 1000, 'caliber:shotgun.heavy|chambers:1|clip:0'),
            ('OMG Beta 9mm', 750, 2800, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('SMI Cadenca 9mm', 650, 2400, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('Paratec Canis 9mm', 500, 2400, -2, '', 'weapon_ranged', 'gun.automatic', '', 1000, 'caliber:pistol.medium|chambers:1|clip:0'),
            ('OMG Delta 7.62', 1500, 4500, 0, '', 'weapon_ranged', 'rifle.automatic', '', 1000, 'caliber:rifle.medium|chambers:1|clip:0'),
            ('AK 47', 1050, 3500, 0, '', 'weapon_ranged', 'rifle.automatic', '', 1000, 'caliber:rifle.medium|chambers:1|clip:0'),
            ('Pulspistole SMI RC 1', 500, 1500, -1, '', 'weapon_ranged', 'gun.blaster', '', 1000, 'caliber:energy.small|chambers:1|clip:0'),
            ('Pulsgewehr SMI RC 2', 1200, 2800, -1, '', 'weapon_ranged', 'rifle.blaster', '', 1000, 'caliber:energy.medium|chambers:1|clip:0'),
            ('Laserpistole SMI Prism', 650, 1400, -1, '', 'weapon_ranged', 'gun.blaster', '', 1000, 'caliber:energy.small|chambers:1|clip:0'),
            ('Lasergewehr ParaTec Lynx', 1300, 3500, 1, '', 'weapon_ranged', 'rifle.blaster', '', 1000, 'caliber:energy.medium|chambers:1|clip:0'),
            ('Ko Punt Gun', 10000, 50000, -3, '', 'weapon_ranged', '', '', 1000, 'dmg:5/-6|chambers:1'),
            ...
            ('Blastermagazin', 30, 100, -4, '', 'clipsnmore', 'clips', '', 500, 'var.Kaliber:leicht.w75.p50,mittel,schwer.w150.p150|var.Kapazität:kleines #.c7.w90,mittleres #.c15,langes #.c30.w125.p150|caliber:energy.'),
            ('Hohlspitzgeschoss', 0.5, 10, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.d+0/-1.w200|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/0'),
            ('SecurGlas™-Geschoss', 0.5, 10, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.d+0/-1.w200|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/+1'),
            ('Vollmantelgeschoss', 1, 10, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.d+0/-1.w200|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/-1'),
            ('Panzerbrechendes Geschoss', 5, 15, -2, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.d+0/-1.w200|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/-2'),
            ('Leuchtspurgeschoss', 3, 15, -1, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/0'),
            ('Signalpatrone', 5, 20, -3, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/+1'),
            ('Platzpatrone', 1, 7, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+1/+1'),
            ('Gummigeschoss', 2, 20, -2, '', 'ammo', '', '', 0, 'var.Waffentyp:Faustfeuerwaffen,Langwaffen.p200.w200,Schrotflinten.p250.w300|var.Kaliber:mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/0/E'),
            ('Flintenlaufgeschoss', 3, 50, -2, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/-2'),
            ('Birdshotpatrone', 1, 50, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/+2'),
            ('Buckshotpatrone', 1, 50, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/+1'),
            ('Buckshotpatrone SecurGlas™', 1, 50, -4, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+3/+2'),
            ('Salzpatrone', 0.5, 50, -2, '', 'ammo', '', '', 0, 'var.Waffentyp:Schrotflinten|var.Kaliber:leicht.p75.w50.d-1/+0,mittel.d+0/+0,schwer.p150.w200.d+1/+0|dmg:+2/+2'),
            ('HLK Typ I', 0.5, 10, -4, '', 'ammo', '', '', 0, 'caliber:energy.small|dmg:+2/+0'),
            ('HLK Typ II', 2, 50, -3, '', 'ammo', '', '', 0, 'caliber.energy.medium|dmg:+2/-2'),
            ('HLK Typ III', 5, 100, -2, '', 'ammo', '', '', 0, 'caliber.energy.heavy|dmg:+3/-2')
        """.trimIndent()
        db.execSQL(sql)
