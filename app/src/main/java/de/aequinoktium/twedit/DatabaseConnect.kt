...
class DatabaseConnect(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, VERSION) {
    ...
    fun first_run(db: SQLiteDatabase) {
        ...
        sql = """
            ...
            ('Streitaxt', 250, 2000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:2/-1'),
            ('Kriegshammer', 250, 2000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:2/0'),
            ('Streitkolben', 250, 2000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:2/0'),
            ('Morgenstern', 250, 2000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:2/0'),
            ('Knüppel', 50, 1000, -5, '', 'weapon', 'blunt', '', 0, 'dmg:2/1'),
            ('Axt', 50, 5000, -5, '', 'tool', '', '', 0, 'dmg:2/0'),
            ('Vorschlaghammer', 50, 5000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:3/0'),
            ('Betäubungsstab', 100, 1000, -2, '', 'weapon', 'blunt', '', 0, 'dmg:3/-1/E'),
            ('Skalpell', 2, 20, -4, '', 'tool', 'knife', '', 0, 'dmg:1/0'),
            ('Cutter', 10, 50, -4, '', 'tool', 'knife', '', 0, 'dmg:1/0'),
            ('Taschenmesser', 20, 100, -4, '', 'tool', 'knife', '', 0, 'dmg:1/0'),
            ('Multitool', 25, 200, -4, '', 'tool', 'knife', '', 0, 'dmg:1/0'),
            ('Küchenmesser', 25, 100, -5, '', 'tool', 'knife', '', 0, 'dmg:1/0'),
            ...
            ('OMG Alpha', 350, 1200, -3, '', 'weapon', 'gun', '', 0, 'dist:15.50|dmg:2/0'),
            ('F&DW Söldner', 400, 850, -2, '', 'weapon', 'gun', '', 0, 'dist:10.40|dmg:2/0'),
            ('ParaTec Vulpus .38', 300, 1250, -3, '', 'weapon', 'gun.revolver', '', 0, 'dist:20.60|dmg:2/0'),
            ('ParaTec Ursus .357', 500, 1250, -3, '', 'weapon', 'gun', '', 0, 'dist:10.50|dmg:2/-1'),
            ('ParaTec Ursus .500', 800, 1750, -1, '', 'weapon', 'gun', '', 0, 'dist:15.75|dmg:3/0'),
            ('ParaTec Ursus 12/76', 1200, 2050, 1, '', 'weapon', 'gun', '', 0, 'dist:15.75|dmg:3/-1'),
            ('II .357 Marshal Art', 750, 1250, -3, '', 'weapon', 'gun.revolver', '', 0, 'dist:10.50|dmg:2/-1'),
            ('OMG Gamma 7.62', 1050, 3500, -1, '', 'weapon', 'rifle', '', 0, 'dist:50.250|dmg:3/-2'),
            ('Paratec Lupus', 950, 3500, 0, '', 'weapon', 'rifle', '', 0, 'dist:50.250|dmg:2/-2'),
            ('Insight Industries Ambassador .223', 1850, 3400, 2, '', 'weapon', 'rifle', '', 0, 'dist:50.250|dmg:2/-2'),
            ('Furthmayr & DeWal Musketier .308', 2150, 3800, 1, '', 'weapon', 'rifle', '', 0, 'dist:50.250|dmg:3/-2'),
            ('Paratec Gulo', 800, 4000, -2, '', 'weapon', 'shotgun', '', 0, 'dist:20.50|dmg:3/1'),
            ('Furthmayr & DeWal Wildschütz', 900, 4800, -2, '', 'weapon', 'shotgun', '', 0, 'dist:20.50|dmg:3/1'),
            ('OMG Beta 9mm', 750, 2800, -2, '', 'weapon', 'gun.automatic', '', 0, 'dist:25.75|dmg:2/0'),
            ('SMI Cadenca 9mm', 650, 2400, -2, '', 'weapon', 'gun.automatic', '', 0, 'dist:25.75|dmg:2/0'),
            ('Paratec Canis 9mm', 500, 2400, -2, '', 'weapon', 'gun.automatic', '', 0, 'dist:25.75|dmg:2/0'),
            ('OMG Delta 7.62', 1500, 4500, 0, '', 'weapon', 'rifle.automatic', '', 0, 'dist:50.250|dmg:3/-2'),
            ('AK 47', 1050, 3500, 0, '', 'weapon', 'rifle.automatic', '', 0, 'dist:50.250|dmg:3/-2'),
            ('Pulspistole SMI RC 1', 500, 1500, -1, '', 'weapon', 'gun.blaster', '', 0, 'dist:25.150|dmg:2/-2/E'),
