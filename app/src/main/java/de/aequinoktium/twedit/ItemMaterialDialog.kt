...
/**
 * A DialogFrament that is used to modify an item color
 * @param col the current color.
 */
class ItemMaterialDialog(var q: Int = 0): DialogFragment()
{
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return activity?.let {
            ...
            val content: View = inflater.inflate(R.layout.dialog_item_material, null)

            builder.setView(content)

            val title = getString(R.string.dialog_item_material_title)
